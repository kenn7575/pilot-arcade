...
async function main() {
  ...
  const achievements = [
    // Distance Traveled
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/distance1.png",
      xpReward: 50,
      coinReward: 5,
    },
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/distance2.png",
      xpReward: 250,
      coinReward: 50,
    },
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/distance3.png",
      xpReward: 500,
      coinReward: 100,
    },
    {
    ...
    }, 
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/distance5.png",
      xpReward: 3000,
      coinReward: 1500,
    },
    ...
    // High Scores
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/score1.png",
      xpReward: 50,
      coinReward: 5,
    },
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/score2.png",
      xpReward: 250,
      coinReward: 50,
    },
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/score3.png",
      xpReward: 500,
      coinReward: 100,
    },
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/score4.png",
      xpReward: 1250,
      coinReward: 500,
    },
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/score5.png",
      xpReward: 3000,
      coinReward: 1500,
    },
    ...
    // Obstacles Avoided
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/shark1.png",
      xpReward: 50,
      coinReward: 5,
    },
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/shark2.png",
      xpReward: 250,
      coinReward: 50,
    },
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/shark3.png",
      xpReward: 500,
      coinReward: 100,
    },
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/shark4.png",
      xpReward: 1250,
      coinReward: 500,
    },
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/shark5.png",
      xpReward: 3000,
      coinReward: 1500,
    },
    ...
    // Fun Extras
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/fail.png",
      xpReward: 100,
      coinReward: 20,
    },
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/early.png",
      xpReward: 50,
      coinReward: 10,
    },
    {
      ...
      gameId: games[0].id,
      imageUrl: "Hajfyldt-Havari/achievements/marathon.png",
      xpReward: 1000,
      coinReward: 200,
    },
  ];
