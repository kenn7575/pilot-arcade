  ...
  return (
    <div className="flex items-center">
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-80 bg-gradient-to-br from-[#f0f] to-[#8800f8]">
          <DropdownMenuItem>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-80 bg-gradient-to-br from-[#fdc830] to-[#f37335]">
          <DropdownMenuItem>
            <div className="flex justify-between space-x-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm">
                  ...
                  Du optjener disse mens du spiller. De kan bruges til at købe
                  nye ting i spillet.
                </p>
              </div>
            </div>
